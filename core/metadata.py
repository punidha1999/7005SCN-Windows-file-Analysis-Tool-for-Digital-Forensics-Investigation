"""
Extracts file metadata from the local filesystem — timestamps, size, NTFS
attributes (hidden/system/read-only), and file owner.

On Windows, st_ctime is the true creation time. On Linux/macOS it is the
inode-change time, which is documented in the GUI with a visible warning.
"""
