"""Builds a chronological event list from file MAC timestamps.

Access timestamps are opt-in because modern systems update atime constantly,
producing thousands of noise events that obscure meaningful file activity.
Includes timestamp anomaly detection (modified < created) which can indicate
anti-forensics tool use or deliberate timestamp manipulation.
"""
