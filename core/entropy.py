"""Per-file Shannon entropy calculation.

Entropy near 8.0 bits/byte means the file's byte distribution is nearly
uniform — consistent with encryption, packing, or compression. The 7.2
threshold used here was chosen empirically; legitimate compressed archives
will appear here too, so context matters when triaging results.
"""
