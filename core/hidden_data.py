"""Suspicious-file detector covering NTFS alternate data streams and attribute heuristics.

ADS enumeration uses the Windows FindFirstStreamW / FindNextStreamW kernel calls
and returns nothing on non-Windows hosts. The suspicion scoring checks for
hidden+system flag combinations, double extensions, executables in temp directories,
and unusually large text files.
"""
