"""Magic-byte signature checker for forensic file-type verification.

Reads the first 512 bytes of each file and matches them against a built-in
database of known file headers. Flags files whose extension contradicts the
detected type (e.g. a .txt file that opens with the PE executable header).
"""
