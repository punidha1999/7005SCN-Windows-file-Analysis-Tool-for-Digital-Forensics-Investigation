"""MD5, SHA-1, and SHA-256 hashing computed in a single file pass.

Designed for forensic integrity verification — the same read loop updates all
three digests simultaneously to avoid scanning large files twice. Includes
duplicate detection and optional matching against external hash sets such as
NSRL or investigator-supplied known-bad lists.
"""
